          ...
          <div className="col-12">
            <div className="filters">
              <Menu mode="horizontal" theme="light">
                ...
                <Menu.Item
                  key="calendar1"
                  /*icon={<CalendarOutlined />}*/ style={{ width: 130 }}
                >
                ...
                <Menu.Item key="type">
                  <Select
                    defaultValue="Type"
                    style={{ width: 120 }} /*onChange={handleTypeChange}*/
                  >
                ...
                <Menu.Item key="version">
                  <Select
                    ...
                    style={{ width: 120 }} /*onChange={handleVersionChange}*/
                  >
                ...
                <Menu.Item key="filter">
                  <Button
                    icon={<FilterOutlined />} /*onClick={handleFilterClick}*/
                  >
                    Filter
                  </Button>
                </Menu.Item>
