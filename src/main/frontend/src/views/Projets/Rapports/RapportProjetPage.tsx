...
const RapportProjetPage = () => {
  ...
  const [columns, setColumns] = useState(["DateCreation", "Nom", "Modeles", "Datasets"]);
  ...
  return (
    <div>
            <div className="position-relative">
                ...
                <ListPage  title="Rapports"  bouton="Créer" boutonVisible={false} onClick={buttonClick }/>
                <div className="position-absolute" style={{top:"160px", left:0, width:"100%"}}>
                  <ElementsList columns={columns} elementsList={listRapports} onDelete={handleDeleteRapport} onShow={onShow} />
                </div>                
            </div>

            <ConfirmationArchiverModal isOpen={showConfirmationModal} onClose={handleCloseConfirmationModal} onConfirm={handleConfirmDeleteRapport} />
