...
function ListEcgPage() {
    ...
    const [listEcg, setListEcg] = useState( [
        {
          idPatient: 1,
    ...
    const [colonnes, setColumns] = useState(["idPatient", "origine_dataset_id", "filepath", "recording_started_at", "recording_ended_at", "recording_initial_sampling_rate", "recording_sampling_rate", "recording_duration", "protocol_details"]);
  ...
  return (
    <div>
            <div className="position-relative">
                <ListPage  title="ECG"  bouton="Créer" boutonVisible={false} onClick={buttonClick }/>
                <div className="position-absolute" style={{top:"160px", left:0, width:"100%"}}>
                  <ElementsList columns={colonnes} elementsList={listEcg} onDelete={handleDeleteEcg} onShow={handleShowEcg} /> 
                </div>
